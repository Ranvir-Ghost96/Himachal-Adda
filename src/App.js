...
import { Kullu } from "./pages/locations/Kullu/Kullu";
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/locations/Shimla" element={<Dubai />} />
          <Route path="/locations/Kullu" element={<Kullu />} />
          <Route path="/locations/Manali" element={<Manali />} />
          <Route path="/locations/himachal" element={<Himachal />} />
          <Route path="/locations/goa" element={<Goa />} />
          <Route path="/locations/Dharamshalla" element={<Maldives />} />
