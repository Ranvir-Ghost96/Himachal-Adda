    ...
    const placeInfo = [
        {
          ...
          desc: "Discover Manali, with world-class tourism and magnificent tailored destinations. Explore a wide range of choices and start planning your trip now! ",
        },
      ];
      const packageInfo = [
        {
    ...
    return(
      ...
      <div className="t-info">
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                  Manali  is open and ready to welcome you again to make new
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                Manali is a trekker's paradise, offering a variety of breathtaking trails 
                that cater to all levels of experience. One of the most popular trekking camps is 
                Hampta Pass, which connects the lush valleys of Manali and Lahaul. This trek is known 
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                For those looking for a more vibrant atmosphere,Manali 
                provide a blend of natural beauty and cultural richness. Nestled in the Dhauladhar Range,
                 these towns are not only known for their scenic views but also for their significance as
                  ...
                  the incredible beauty and diversity of Manali , making it an ideal destination 
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                Another significant temple is the Hadimba Devi Temple,
        ...
        <h2 className="heading" id="indubai">
          <span id="fdiff">O</span>nly in Manali
          <hr />
        </h2>
        <div className="t-row">
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                Manali offers a wealth of unique activities that cater to adventure 
        ...
        <div className="more">
          ...
          <div className="cont">
            <p>
            A trip to Manali  offers a diverse array of experiences, 
            ...
            paragliding in Bir Billing, and river rafting in the Beas River.
             For those interested in local culture, attending traditional festivals
              or visiting ancient monasteries in Spiti Valley provides a deep insight
               into the region's heritage. Travelers can also savor delicious Manalii 
