    ...
    const placeInfo = [
        {
          ...
          desc: "Discover Kullu, with world-class tourism and magnificent tailored destinations. Explore a wide range of choices and start planning your trip now! ",
        },
      ];
      const packageInfo = [
        {
    ...
    return(
      ...
      <div className="t-info">
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                  Kullu  is open and ready to welcome you again to make new
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                Kullu is a trekker's paradise, offering a variety of breathtaking trails 
          ...
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                For those looking for a more vibrant atmosphere,Kullu 
                provide a blend of natural beauty and cultural richness. Nestled in the Dhauladhar Range,
                 these towns are not only known for their scenic views but also for their significance as
                  ...
                  the incredible beauty and diversity of Kullu , making it an ideal destination 
        ...
        <h2 className="heading" id="indubai">
          <span id="fdiff">O</span>nly in Kullu
          <hr />
        </h2>
        <div className="t-row">
          <div className="infobox module">
            <div className="box">
              <div className="title">
                ...
                <p>
                Kullu offers a wealth of unique activities that cater to adventure 
        ...
        <div className="more">
          ...
          <div className="cont">
            <p>
            A trip to Kullu  offers a diverse array of experiences, 
            ...
            paragliding in Bir Billing, and river rafting in the Beas River.
             For those interested in local culture, attending traditional festivals
              or visiting ancient monasteries in Spiti Valley provides a deep insight
               into the region's heritage. Travelers can also savor delicious Kullui 
               cuisine and explore charming villages, making for an enriching and memorable
                journey through this picturesque state. Whether you seek relaxation or adventure,
                 Kullu has something for everyone.
            </p>
          </div>
        </div>
      </div>
